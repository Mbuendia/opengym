...
export default {
  ...
  "This browser doesn't support passkeys — you can still use openGym locally on this device.": 'Este navegador no admite passkeys — aun así puedes usar YourGym localmente en este dispositivo.',
  ...
  'to install YourGym as a full-screen app.': 'para instalar YourGym como app a pantalla completa.',
  ...
  'Rest-timer alerts, even if YourGym is closed.': 'Avisos del temporizador de descanso, incluso con YourGym cerrado.',
  ...
  'A small file a friend imports into their own YourGym — routines only, none of your workouts or weigh-ins.': 'Un archivo pequeño que un amigo importa en su propio YourGym: solo rutinas, ninguno de tus entrenamientos ni pesajes.',
